...
<img src={pictoEnergy} className="keysContainer-content-list-element-zone-picto-color-picto" alt="calorie"/>
</div>
</div>
...
<img src={pictoChicken} className="keysContainer-content-list-element-zone-picto-color-picto" alt="proteine"/>
</div>
</div>
<div className="keysContainer-content-list-element-zone-text">
<div className="keysContainer-content-list-element-zone-text-group">
...
<img src={pictoApple} className="keysContainer-content-list-element-zone-picto-color-picto" alt="glucide"/>
</div>
</div>
<div className="keysContainer-content-list-element-zone-text">
<div className="keysContainer-content-list-element-zone-text-group">
...
<img src={pictoCheeseburger} className="keysContainer-content-list-element-zone-picto-color-picto" alt="lipide"/>
</div>
</div>
<div className="keysContainer-content-list-element-zone-text">
<div className="keysContainer-content-list-element-zone-text-group">
